...
public class OrganizationController {
    ...
    @RequestMapping(value = "/list")
       public List<OrganizationView> getOrgByFilter (@RequestBody FilterView view)  {
    ...
    @ApiOperation(value = "Получить список орг по id", httpMethod = "GET")
        ...
        public OrganizationView getOrgById(@PathVariable ("id") Long id){
    ...
    @ApiOperation(value = "Сохранить измнения", httpMethod = "POST")
